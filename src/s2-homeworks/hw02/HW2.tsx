...
/*
* 1 - описать типы AffairPriorityType, AffairType С БОЖЬЕЙ ПОМОЩЬЮ СДЕЛАЛ!!!
...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => { // need to fix any
    ...
    else return defaultAffairs.filter((filterName) => filterName.priority === filter)
}
export const deleteAffair = (affairs: AffairType[], _id: number): AffairType[] => { // need to fix any
    return affairs.filter((value, index) => _id !== value._id) // need to fix
}
